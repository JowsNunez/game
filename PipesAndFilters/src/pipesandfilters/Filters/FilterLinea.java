...
public class FilterLinea implements Filter<LineaDTO, Linea, PipeLinea> {
    ...
    public void procesar(LineaDTO objeto) {
        Jugador jugador = new Jugador.JugadorBuilder(objeto.getJugador().getNombre(), objeto.getJugador().getRutaAvatar(), objeto.getJugador().getColor())
                .id(objeto.getJugador().getUniqueID())
                .build();
